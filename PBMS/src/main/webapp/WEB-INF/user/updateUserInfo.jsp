...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/user/updateUserInfo.js"></script>
</head>
<body>
	<div id="main" class="index">
		<form id="updateUser_form" method="POST" enctype="multipart/form-data">
			<div id="index"></div>
			<div id="table">
				<table>
					...
					<tbody>
						...
						<tr>
							<th><p>密码</p></th>
							<td><input name="userPwd" id="userPwd" type="password" value="${requestScope.userVO.userPwd }" /></td>
							<td><div>
									<p class="release_error_word"></p>
								</div></td>
						</tr>
					...
					<tfoot>
						<tr>
							<td colspan="3">
								<ul>
									<li><input onclick="updateUser_submit()" type="button" value="确定" class="button"
