 ...
 (function(){
  ...
  var isConfirmDivBuilded = false;
    function BuildConfirmDiv(){
        ...
        strConfirm +="          <div class='message_close'><a href='#'><img  id='confirmCloseButton'  style='cursor:pointer;' src='../../css/images/close.gif' alt='Close' title='Close' width='40' height='40' /></a></div></td>";
        strConfirm +="      </tr>";
        strConfirm +="    </table>";
        strConfirm +="  </div>";
        ...
        strConfirm +="      </tr>";
        strConfirm +="      <tr>";
        strConfirm +="        <td class='message_leftcontain'><img src='../../css/images/query.gif' alt='Query' title='Query' width='40' height='40' /></td>";
